import { ChevronRightIcon, PlusIcon, SearchIcon } from '@heroicons/react/outline'
...
function Home() {
    ...
    return (
      ...
      <div>
       ...
       text-gray-700 leading outline-none"
              id="username" type="text" placeholder="Search food by name" />
        ...
        <button
          ...
          <div className="mt-5 mb-5 mr-10 ml-10 items-center justify-center content-center flex flex-col">
            ...
            <div className="bg-white h-12 w-12 justify-center items-center rounded-full mt-0 flex">
              <img src={menu?.menu_image} alt={menu?.menu_image} className="w-6 h-6" />

            </div>

            <div className={checkSelectedCategory(menu) ? "mt-5 font-bold text-sm text-white" : "mt-5 font-bold text-sm"}>{menu?.name}</div>
          ...
          <div className="mt-0 mb-5 mr-10 ml-10 items-center justify-center content-center flex flex-col relative">
            ...
            <div className="bg-white shadow-2xl rounded-lg w-60 items-start justify-start flex flex-col mt-5">
              ...
              <div className="mt-0 mb-5 mr-5 ml-5 flex justify-between items-center flex-row w-48">
                ...
                <div>
                  <label className=" text-orange-400 font-bold text-xs">$</label>
                  <label className="font-bold text-md">{food_item?.price.toFixed(2)}</label>
                </div>
  ...
  function checkSelectedCategory(menu) {
    ...
    if (typeof selectedCategory !== "undefined" && selectedCategory !== null && selectedCategory?.id === menu?.id) {
      return true
    } else {
      return false
    }
