        ...
        <div className="mt-10 flex flex-row justify-end">
          ...
          <div className="ml-6 mr-5 flex items-center">
            ...
            <div className="ml-3 flex-col flex">
              <label className="text-md font-semibold">{user?.first_name}</label>
            ...
            <div className="ml-5 mr-5 mb-3 flex flex-row justify-between">
              ...
              <div>
                <div className="flex flex-col">
                  <label className="text-white text-lg">$ {card?.balance.toFixed(2)}</label>
                  <label className="text-white text-xs mt-2">{card?.holder_name}</label>
                </div>
              </div>

              <div>
                <div className="flex flex-col">
                  <label className="text-white text-sm">Expiry {card?.expiry_date}</label>
                  <label className="text-white text-xs mt-3">{card?.card_number}</label>
                </div>
              </div>
          ...
          <div className="flex flex-row justify-between items-center mb-3 ml-3">
            ...
            <div className="flex flex-row mt-3">
              ...
              <div className="h-16 w-16 bg-cyan-100 rounded-xl flex items-center justify-center">
                <img src={cart_item?.food_image} alt={cart_item?.food_image} className="w-12 h-12 rounded-full" />
